...
export default class App extends React.Component {
  ...
  render() {
    ...
    return isLoading ? <Loading /> : <Weather name={name} temp_max={Math.round(temp_max)} temp_min={Math.round(temp_min)} temp={Math.round(temp)} condition={condition} />;
